...
def animate(i):
    ...
    im = plt.contourf(xig_2, yig_2, zi_2, cmap=cm.jet, antialiased=True, vmin=0, vmax=1600000, linewidth=0.2)
    plt.scatter(x,y)
    print(i)
    return im,

im_ani = animation.FuncAnimation(fig2, animate, 200, interval=1000, blit=False, repeat=False)
