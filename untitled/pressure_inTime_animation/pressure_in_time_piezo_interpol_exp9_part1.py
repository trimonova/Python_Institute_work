...
print(list(pt[8]).index(max(pt[8])))
...
def pressure_in_exp(Pprod, Lx, Ly, set_coord, t_current):
    ...
    set_with_P[(0.057, 0.127)] = Pprod
    print(set_with_P[set_coord[1]], set_with_P[set_coord[7]], set_with_P[set_coord[10]])
    ...
    wells_with_P = {}
    wells_with_P[(0.057, 0.127)] = Pprod
...
levels = list(range(0, 2000000, 100000))

def animate(t_current):
    set_with_P_mesh, set_with_P, wells_with_P_mesh = pressure_in_exp(Pprod, Lx, Ly, set_coord, 216000+t_current*10)
    print(t_current)
