...
# учитывается изменение давление на скважине. Можем брать несколько моментов времени, можно смотреть, как будут отличаться графики.
...
# Далее строятся теоритические прямые падения давления от расстояния, Далее на график накладываются значения давлений в точках-датчиках в зависимости от расстояния до центра;
