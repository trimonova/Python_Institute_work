...
def animate(t):
    ...
    if t < T_exp:
        ...
        surf = plt.contourf(xig, yig, Pi, cmap=cm.jet, antialiased=True, vmin=np.nanmin(Pi), vmax=2000000,
...
fig = plt.figure()
plt.axis('equal')
im_ani = animation.FuncAnimation(fig, animate, 50, interval=100, blit=False, repeat=False)
